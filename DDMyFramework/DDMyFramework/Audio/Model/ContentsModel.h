...
@interface ContentsModel : FYBaseModel
...
@end
@interface ContentFocusimages : FYBaseModel
...
@interface CFocusimages_List : FYBaseModel
...
@interface ContentTags : FYBaseModel
...
@interface ContentTags_List : FYBaseModel
...
@interface ContentCategorycontents : FYBaseModel
...
@interface CCategoryCotents_List : FYBaseModel
...
@interface CCategoryCotents_L_List : FYBaseModel
...
@interface CC_L_L_Firstkresults : FYBaseModel
